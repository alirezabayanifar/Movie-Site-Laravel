...
class GetMoviesCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'get all movies details';
    ...
    public function handle(): int
    {
        ...
        $file = file_get_contents(storage_path('data.json'), 'data.json');
    ...
    public function saveMovie($movie): bool
    {
        ...
        $newMovie = Movie::create([
            ...
            'type' => $movie['Type'],
            'dvd' => $movie['DVD'] == "N/A" ? null : Carbon::parse($movie['DVD'])->format('Y-m-d'),
